...
<head>
    ...
    @if (Route::currentRouteName() == 'calendar' ||
            Route::currentRouteName() == 'notification' ||
    ...
    @if (Route::currentRouteName() == 'member.register.form' ||
            Route::currentRouteName() == 'attendance' ||
            Route::currentRouteName() == 'attendance.mark' ||
            Route::currentRouteName() == 'collection.offering' ||
            Route::currentRouteName() == 'calendar' ||
            Route::currentRouteName() == 'ticket')
    ...
    @if (Route::currentRouteName() == 'member.register.form' ||
            Route::currentRouteName() == 'attendance.view.form' ||
            Route::currentRouteName() == 'collection.offering' ||
            Route::currentRouteName() == 'attendance')
    ...
    @if (Route::currentRouteName() == 'member.profile' ||
            Route::currentRouteName() == 'attendance.analysis' ||
...
<body>
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
                ...
                <div class="navbar-header">
                    <a href="{{ url('/dashboard') }}" class="navbar-brand">
                        ...
                        <div class="brand-title">
                            <span class="brand-text">{{ strtoupper(\Auth::user()->branch->branchname) }}</span>
                        </div>
                    </a>
                </div>
                <!--================================-->
                        ...
                        <li id="dropdown-user" class="dropdown">
                            <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                                <span class="ic-user pull-right">
                                    ...
                                    <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                                    <i class="fa fa-user"> Hello {{ \Auth::user()->branch->branchname }}</i>
                                </span>
                                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                        ...
                        <div class="nano">
                            <div class="nano-content">
                                    ...
                                    <div class="profile-wrap text-center">
                                        ...
                                        <a href="dashboardprofile-nav" class="box-block" data-toggle="collapse"
                                            ...
                                            <p class="mnp-name"><!--span class="flag-icon flag-icon-ng"></span-->
                                                {{ \Auth::user()->branch->branchname }}</p>
                                            <p class="mnp-desc">{{ \Auth::user()->branch->branchcode }}</p>
                                        </a>
                                    </div>
                                </div>
                                <!--Shortcut buttons--> <!--================================-->
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li
                                        class="{{ Route::currentRouteName() == 'members.all' || Route::currentRouteName() == 'member.register.form' ? 'active-sub active' : '' }}
									...
									{{ Route::currentRouteName() === 'attendance' ? 'active-sub active' : '' }}">
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li
                                                ...
                                                <a href="{{ route('attendance.view.form') }}"><i
                                                        class="fa fa-eye"></i> View Attendance</a>
                                            </li>
                                            <li
                                                class="{{ Route::currentRouteName() === 'attendance.analysis' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('attendance.analysis') }}"><i
                                                        class="fa fa-signal"></i> Analysis</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <!--Menu list item-->
                                    <li
                                        ...
                                        <ul class="collapse">
                                            <li
                                                ...
                                                <a href="{{ route('collection.offering') }}"><i
                                                        class="fa fa-save"></i> Save Collection</a>
                                            </li>
                                            <li
                                            ...
                                            <li
                                                ...
                                                <a href="{{ route('collection.analysis') }}"><i
                                                        class="fa fa-signal"></i> Analysis</a>
                                            </li>
                                    ...
                                    <li
                                        ...
                                        <ul class="collapse">
                                            <li
                                                ...
                                                <a href="{{ route('email') }}"><i class="fa fa-envelope"></i>
                                                    Email</a>
                                            </li>
                                            <li
                                                class="{{ Route::currentRouteName() === 'sms' ? 'active-sub active' : '' }}">
                                                <a href="{{ route('sms') }}"><i class="fa fa-mobile"></i> Bulk
                                                    SMS</a>
                                            </li>
                                            <li
        ...
        <footer id="footer">
            ...
            <div class="hide-fixed pull-right pad-rgt">
                Powered By <a href="https://myckhel.adbin.com.ng" style="color:#274868;font-weight:bolder"> Myckhel
                </a>
            </div>
            <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
 ...
 <script src="{{ URL::asset('js/jquery-3.2.1.slim.min.js') }}"></script> -->
    ...
    @if (Route::currentRouteName() == 'member.register.form' ||
            Route::currentRouteName() == 'attendance.view' ||
            Route::currentRouteName() == 'collection.offering' ||
            Route::currentRouteName() == 'members.all')
        ...
        <script>
            ...
            function get_msg(to, from) {
                $('#inbox-chat-body').html(
                    `<div id="wait" style="display:none;width:69px;height:89px;position:absolute;top:50%;left:50%;padding:2px;"><img src="{{ URL::asset('images/msg-loader.gif') }}" width="64" height="64" /><br>Loading..	</div>`
                );
