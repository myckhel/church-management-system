                        ...
                        <div class="fixed-sm-200 pull-sm-left fixed-right-border">
                            <form method="POST" action="{{ route('calendar.update') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" id="event_title" placeholder="Event Title..." name="title"
                                        class="form-control" value="" style="margin-bottom:15px" required>
                                    <input type="text" id="event_title" placeholder="By who" name="by_who"
                                    ...
                                    <select id="num-selector" data-live-search="true" name="assign[]" data-width="100%"
                                        ...
                                        @foreach ($pastors as $pastor)
                                            <option id="event_title" value="{{ $pastor->email }}">
                                                {{ ucwords($pastor->getFullname()) }}</option>
                                        @endforeach
                                    </select>
                                    <br />
                                    <input type="text" id="event_title" placeholder="Location" name="location"
                                        class="form-control" value="" required>
                                    <input type="text" id="event_title" placeholder="details" name="details"
                                        class="form-control" value="" required>
                                  ...
                                  width: 100%;
                                   color: #555;
                                  background-color: #fff;outline:none; margin-top:15px;padding:2px 10px"
                                        type="text" placeholder="Event Date" name="date" class="datepicker"
                                        required />
                                </div>
                ...
                <div class="modal-dialog" style="width: 50%; margin: 0 auto;">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <li
                                class="text-center bg-purple list-group-item d-flex justify-content-between align-items-center">
                                Details:
                            </li>
                        ...
                        <div class="modal-footer">
                            <button id="id" type="button" class="btn btn-danger" value=""
                                data-dismiss="modal" onclick="dele(this.value);">Delete</button>
                ...
                <div class="modal-body">
                    ...
                    <p>This
                        <button class="btn btn-sm btn-warning demo-modal-popover add-popover" data-toggle="popover"
                            data-trigger="focus"
                            data-content="And here's some amazing content. It's very engaging. right?"data-original-title="Popover Title">button</button>
                        should trigger a popover on click.
                    </p>
                    <br>
                    <p class="text-semibold text-main">Tooltips in a modal</p>
                    <p>
                        <a class="btn-link text-bold add-tooltip" href="ui-modals.html#"
                            data-original-title="Tooltip">This link</a> and
                        <a class="btn-link text-bold add-tooltip" href="ui-modals.html#"
                            data-original-title="Tooltip">that link</a> should have tooltips on hover.
                    </p>
                </div>
