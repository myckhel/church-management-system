                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-primary badge-pill">{{ $currency }}
                                                {{ number_format($reports->total_collections) }}</span>
                                        </td>
                                        <td>
                                            <span class="badge badge-primary badge-pill">{{ $currency }}
                                                {{ number_format($reports->todays_total_collections) }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($memberTotal as $key => $mc)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge badge-primary badge-pill">{{ $currency }}
                                                    {{ number_format($mc['total']) }}</span>
                                            </td>
                                            <td>
                                                <span class="badge badge-primary badge-pill">{{ $currency }}
                                                    {{ number_format($mc['today']) }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
