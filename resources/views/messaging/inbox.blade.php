                                    ...
                                    <div class="contacts-outter">
                                        <ul class="list-unstyled contacts success">
                                            @foreach ($members as $branch)
                                                @if ($branch->isOnline())
                                                    <li data-toggle="tab" data-target="#inbox-message"
                                                        onclick="get_msg('{{ $user }}','{{ $branch->branchcode }}')">
                                                        <img alt="" class="img-circle medium-image"
                                                            src="https://bootdey.com/img/Content/avatar/avatar1.png">

                                                        <div class="vcentered info-combo">
                                                            <h3 class="no-margin-bottom name"> {{ $branch->getName() }}
                                                            </h3>
                                                            <div
                                                                class="{{ $branch->isOnline() ? 'online-count' : 'offline-count' }}">
                                                            </div>
                                                            <h5> <?php if ($branch->isOnline()) {
                            ...
                            <div class="tab-pane message-body" id="activity">
                                <div class="message-top">
                                    ...
                                    <div class="new-message-wrapper">
                                        ...
                                        <div class="chat-footer new-message-textarea">
                                            ...
                                            <button id="send-reply" type="button" class="send-message-button btn-info">
                                                <i class="fa fa-send"></i> </button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="message-chat">
                                    ...
                                    <div class="chat-footer">
                                        ...
                                        <button type="button" class="send-message-button btn-info"> <i
