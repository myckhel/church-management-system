...
@section('link')
    ...
    <link href="{{ URL::asset('plugins/x-editable/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css') }}"
        rel="stylesheet">
    <!--Address [ OPTIONAL ]-->
                                ...
                                <tbody>
                                    ...
                                    @if (Auth::user()->isAdmin())
                                        <tr>
                                            ...
                                            <td><a href="#" id="collection_commission" data-type="number"
                                                    data-pk="1" data-placement="right" data-placeholder="e.g, 20"
                    ...
                    $.ajax({
                        ...
                        .done((res) => {
                            if (res.status) {
                                ...
                                $("#bank_select").append(
                                    `<option selected value="${dt.commission_account_bank}">${res_.find(({value}) => value === dt.commission_account_bank)?.text }</option>`
                                )
